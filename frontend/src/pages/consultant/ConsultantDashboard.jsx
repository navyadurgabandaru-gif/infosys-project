    ...
    <div className="card">
      <div className="table-wrap">
        <table className="data-table">
          <thead><tr><th>User</th><th>Skin Type</th><th>Latest Score</th><th>Last Assessment</th><th>Export</th><th></th></tr></thead>
          <tbody>
            {users.map((u) => (
              <tr key={u.id}>
                <td>{u.name}</td>
                ...
                <td><PatientReportExportButtons userId={u.id} label={u.name} /></td>
                <td>
